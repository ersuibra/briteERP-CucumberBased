...
public class ExcelWriteDemo {
    ...
    public void writeExcel() throws Exception {
        String filePath = "C:\\Users\\ASUSNB\\Documents\\Countries.xlsx";
        ...
        column.setCellValue("Continents");
        ...
        Cell cont2 = worksheet.getRow(2).getCell(2);
        if(cont2==null){
            cont2 = worksheet.getRow(2).getCell(2);
        }
